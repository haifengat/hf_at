...
namespace HaiFeng
{
	public static class HFLog
	{
		...
		{
			_logger.Log(pLevel ?? NLog.LogLevel.Debug, "{0,4}|{1,-10}|{2,-12}|{3}", pLineNumber, pCallName, new FileInfo(pFileName).Name, pMsg);
		}
		...
		{
			_logger.Log(NLog.LogLevel.Trace, "{0,4}|{1,-10}|{2}", /*new FileInfo(pFileName).Name,*/ pLineNumber, pCallName, pMsg);
		}
		...
		{
			_logger.Log(NLog.LogLevel.Info, "{0,4}|{1,-10}|{2}", /*new FileInfo(pFileName).Name,*/ pLineNumber, pCallName, pMsg);
		}
		...
		{
			_logger.Log(NLog.LogLevel.Debug, "{0,4}|{1,-10}|{2}", /*new FileInfo(pFileName).Name,*/ pLineNumber, pCallName, pMsg);
		}
		...
		{
			_logger.Log(NLog.LogLevel.Warn, "{0,4}|{1,-10}|{2}", /*new FileInfo(pFileName).Name,*/ pLineNumber, pCallName, pMsg);
		}
		...
		{
			_logger.Log(NLog.LogLevel.Error, "{0,4}|{1,-10}|{2}", /*new FileInfo(pFileName).Name,*/ pLineNumber, pCallName, pMsg);
